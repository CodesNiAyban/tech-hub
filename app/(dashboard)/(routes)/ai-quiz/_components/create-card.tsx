...
export const CreateQuiz = ({ topic }: CreateQuizProps) => {
    ...
    const { mutate: getQuestions, isPending } = useMutation({
        mutationFn: async ({ amount, topic, type, level }: z.infer<typeof quizCreationSchema>) => {
            const response = await axios.post("/api/quiz/game", { amount, topic, type, level });
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    <FormDescription>
                                        You can choose the level you would like to be
                                        quizzed on here.
                                    </FormDescription>
                                    <FormMessage />
                                </FormItem>
